...
(function () {
  const D = {
    ko: {
      ...
      gender: "성별", female: "여자", male: "남자", hair: "헤어 스타일", hairColor: "헤어 컬러", skin: "피부색", outfit: "옷",
      ...
      albumsIntro: "💿 조젤리의 발매 이력이에요.", listen: "▶ 듣기", noVideo: "등록된 영상이 없어요.", ytChannel: "YouTube 채널 가기 ↗",
    ...
    en: {
      ...
      gender: "Gender", female: "Female", male: "Male", hair: "Hair style", hairColor: "Hair color", skin: "Skin tone", outfit: "Outfit",
      ...
      albumsIntro: "💿 Jo Jelly's discography.", listen: "▶ Listen", noVideo: "No videos yet.", ytChannel: "Visit YouTube channel ↗",
      ...
      hairs: ["Short", "Long", "Ponytail", "Bob", "Spiky"],
    ...
    ja: {
      ...
      gender: "性別", female: "女の子", male: "男の子", hair: "ヘアスタイル", hairColor: "ヘアカラー", skin: "肌の色", outfit: "服",
      ...
      albumsIntro: "💿 Jo Jelly のリリース履歴です。", listen: "▶ 聴く", noVideo: "動画はまだありません。", ytChannel: "YouTube チャンネルへ ↗",
